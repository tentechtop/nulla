...
const DESIGN_CONTENT_HEIGHT = 1712;
...
function getTransferSendLayoutMetrics(viewportWidth, topSafeArea, bottomSafeArea) {
...
exports.getTransferSendLayoutMetrics = getTransferSendLayoutMetrics;
