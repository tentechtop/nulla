...
const DESIGN_CONTENT_HEIGHT = 1460;
...
function getPortfolioAnalyticsLayoutMetrics(viewportWidth, topSafeArea, bottomSafeArea) {
...
exports.getPortfolioAnalyticsLayoutMetrics = getPortfolioAnalyticsLayoutMetrics;
