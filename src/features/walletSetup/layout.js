...
const DESIGN_CONTENT_HEIGHT = 1618;
...
function getWalletSetupLayoutMetrics(viewportWidth, topSafeArea, bottomSafeArea) {
...
exports.getWalletSetupLayoutMetrics = getWalletSetupLayoutMetrics;
