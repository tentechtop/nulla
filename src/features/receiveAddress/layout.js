...
const DESIGN_CONTENT_HEIGHT = 1588;
...
function getReceiveAddressLayoutMetrics(viewportWidth, topSafeArea, bottomSafeArea) {
...
exports.getReceiveAddressLayoutMetrics = getReceiveAddressLayoutMetrics;
