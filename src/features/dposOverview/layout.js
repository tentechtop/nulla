...
const DESIGN_CONTENT_HEIGHT = 1595;
...
function getDposOverviewLayoutMetrics(viewportWidth, topSafeArea, bottomSafeArea) {
...
exports.getDposOverviewLayoutMetrics = getDposOverviewLayoutMetrics;
